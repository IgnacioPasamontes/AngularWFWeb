...
var EachWorkflowComponent = /** @class */ (function () {
    ...
    EachWorkflowComponent.prototype.ngAfterViewInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.getProjectInfoSync(this.globals.current_user.projects[this.projectName])];
                    case 1:
                        nodes_info = _a.sent();
    ...
    EachWorkflowComponent.prototype.nodeInfo_selected = function (project, node_id) {
        var _this = this;
        var project_id = this.globals.current_user.projects[project];
        // GET ID PROJECT
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.getUserProjects = function () {
        ...
        this.getprojects_subscription = this.login.getProjects().subscribe(function (result2) {
            ...
            _this.globals.current_user.setProjects(projects);
        }, function (error) {
